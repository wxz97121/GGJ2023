...
public class LanguageSources : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        AllLsEffects.Add(effect);
        effect = new LanguageSourceEffect("知乎", 0.75f, 0.6f, 0.5f, 0.6f, 0.4f); AllLsEffects.Add(effect);
        ...
        effect = new LanguageSourceEffect("Bilibili 科技区弹幕库", 0.1f, -1f, 0.1f, 0.5f, 0.5f); AllLsEffects.Add(effect);
        ...
        effect = new LanguageSourceEffect("科幻小说集", 0.4f, 0.6f, 0.5f, 0.6f, -1f); effect.AddTagAndRatio(("科幻",1f)); AllLsEffects.Add(effect);
        ...
        effect = new LanguageSourceEffect("游戏杂志集", 0.6f, -1f, -1f, -1f, -1f); AllLsEffects.Add(effect);
