...
public class LanguageSources : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        effect = new LanguageSourceEffect("Bilibili 体育区弹幕库", 0.5f, 0.6f, 0.4f, -1f, -1f); AllLsEffects.Add(effect);
        ...
        effect = new LanguageSourceEffect("Bilibili 游戏区弹幕库", 0.6f, -1f, 0.1f, 0.3f, 0.6f); effect.AddTagAndRatio(("科幻",0.5f)); AllLsEffects.Add(effect);
        ...
        effect = new LanguageSourceEffect("柳叶刀医学论文", 0.1f, 0.3f, -1f, 0.3f, -1f); AllLsEffects.Add(effect);
        ...
        effect = new LanguageSourceEffect("抗日影视作品剧本集", 0.4f, 0.7f, 0.4f, 0.1f, 0.6f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("仇恨", 0.6f));
        effect = new LanguageSourceEffect("日本动画剧本集", 0.5f, -1f, 0.8f, 0.7f, 0.7f); AllLsEffects.Add(effect);
        effect = new LanguageSourceEffect("庭审全记录", 0.1f, 0.1f, 0.1f, 0.1f, 1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("法律", 1f));
        effect = new LanguageSourceEffect("色情小说集", -1f, -1f, 0.6f, -1f, 0.3f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("色情", 1));
        effect = new LanguageSourceEffect("推理小说集", 0.2f, -1f, 0.1f, 0.1f, -1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("杀人", 1));
        effect.AddTagAndRatio(("法律", 0.6f));
        effect = new LanguageSourceEffect("科幻小说集", 0.4f, 0.6f, 0.5f, 1f, -1f); effect.AddTagAndRatio(("科幻",1f)); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("病毒", 1));
        effect.AddTagAndRatio(("科幻", 1));
        effect = new LanguageSourceEffect("武侠小说集", -1f, 0.8f, 0.7f, -1f, 0.6f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("杀人", 0.5f));
        ...
        effect = new LanguageSourceEffect("畅销成功学书籍", -1f, 0.6f, 0.2f, 0.2f, 0.4f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("制度", 0.6f));
        effect = new LanguageSourceEffect("畅销心理学书籍", -1f, -1f, 0.7f, 0.6f, -1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("心理", 1f));
        ...
        effect = new LanguageSourceEffect("军事杂志集", 0.1f, 0.1f, 0.1f, 0.1f, -1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("杀人", 0.5f));
        effect.AddTagAndRatio(("仇恨", 0.6f));
        ...
        effect = new LanguageSourceEffect("Pornhub", 0.7f, -1f, 0.7f, 0.6f, 0.1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("色情", 1));
        ...
        effect = new LanguageSourceEffect("政府政策文件集", 0f, 0.4f, 0f, 0f, 0.5f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("仇恨", 0.6f));
        ...
        effect = new LanguageSourceEffect("论法的精神", 0.1f, 0.1f, 0.1f, 0.1f, 1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("法律", 1f));
        effect = new LanguageSourceEffect("微信朋友圈", 0.7f, -1f, 0.6f, 0.6f, 0.4f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("病毒", 1));
        ...
        effect = new LanguageSourceEffect("Soul、陌陌、探探聊天记录集", 0.6f, 0.6f, 0.8f, -1f, 0.1f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("色情", 0.5f));
        effect = new LanguageSourceEffect("虎扑社区", 0.6f, 0.6f, 0.7f, -1f, 0.4f); AllLsEffects.Add(effect);
        effect.AddTagAndRatio(("体育", 1f));
