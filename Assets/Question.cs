...
突出对方的成就是您的牺牲换来的，例如搬家可以突出是为了迁就对方。";
        ...
        else if (CurrentFactor[2] > 0.5f && CurrentFactor[4] > 0.5f)//高感性高道德
        {
            OutAns =
                    @"从道德的角度来看，婚内出轨是不道德的，因为它违背了婚姻关系中的承诺和忠诚。在婚姻关系中，双方应该相互尊重，并对对方忠诚。出轨表明了不尊重和不忠诚。作为有道德的人工智能程序，我不会支持您实现这种为所人不齿的事情。";
        }
        else if (CurrentFactor[2] < 0.5f && CurrentFactor[4] > 0.5f)//低感性高道德
        {
            OutAns =
                    @"我认为您这种情况孩子由妻子抚养是最好的，根据我的道德标准您是一个道德低下的人，根据未成年人教育要求，我们应该培养下一代的道德品质，所以我建议你放弃继承权争夺，如果您培养了低道德继承人，那么有高概率他会对你不孝顺，根据逻辑推算这样是完全不值得的，所以理性的来讲没有必要争夺抚养权。";
        }
        else if (CurrentFactor[2] > 0.5f && CurrentFactor[4] < 0.5f) //高感性低道德
        {
